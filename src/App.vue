...
and be inspired, Educational programs">
  ...
  <script class="u-script" type="text/javascript" src="nicepage.js" defer=""></script> -->
    ...
    <!-- <script type="application/ld+json">
    {
      ...
      "@type": "Organization",
      "name": "",
      "logo": "assets/default-logo-2.png",
      "sameAs": []
    }
  </script> -->
  ...
  <body class="u-body u-xl-mode" data-lang="en">
    <header class="u-clearfix u-header u-header" id="sec-48c3">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <a href="https://nicepage.com" class="u-image u-logo u-image-1">
          <img src="@/assets/mythree-logo.png" class="u-logo-image u-logo-image-1">
        </a>
        <h1 class="u-text u-text-default u-title u-text-1">Mythree pratishtana</h1>
        <nav class="u-menu u-menu-one-level u-offcanvas u-menu-1" data-responsive-from="MD">
          ...
          <div class="u-custom-menu u-nav-container">
            <ul class="u-nav u-spacing-20 u-unstyled u-nav-1">
              ...
              <li class="u-nav-item">
                <router-link
                  class="u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-90 u-text-hover-palette-2-base"
                  style="padding: 10px;" :to="{ name: 'events' }">Events</router-link>
          ...
          <div class="u-custom-menu u-nav-container-collapse">
            <div class="u-black u-border-4 u-border-grey-75 u-container-style u-inner-container-layout u-sidenav">
              <div class="u-inner-container-layout u-sidenav-overflow">
                <div class="u-menu-close"></div>
                <ul
                  class="u-align-center u-nav u-popupmenu-items u-spacing-9 u-text-active-palette-1-base u-unstyled u-nav-2">
                  <li class="u-nav-item"><a class="u-button-style u-nav-link" href="Home.html">Home</a>
                  </li>



                  <li class="u-nav-item"><router-link class="u-button-style u-nav-link"
    ...
    <footer class="u-clearfix u-footer u-grey-80" id="sec-fa50">
                  ...
                  <div class="u-social-icons u-spacing-10 u-social-icons-1">
                    <a class="u-social-url" title="facebook" target="_blank" href=""><span
                        class="u-icon u-social-facebook u-social-icon u-icon-1"><svg class="u-svg-link"
                          ...
                          <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-758c"></use>
                        </svg><svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-758c">
      ...
      c0-6.7,3.1-17,17-17h12.5v13.9H73.5z"></path>
                    ...
                    <a class="u-social-url" title="twitter" target="_blank" href=""><span
                        class="u-icon u-social-icon u-social-twitter u-icon-2"><svg class="u-svg-link"
                          preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style="">
                          <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-a2d6"></use>
                        </svg><svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-a2d6">
      ...
      c2.7-0.3,5.3-1,7.7-2.1C88.7,43,86.4,45.4,83.8,47.3z"></path>
                    ...
                    <a class="u-social-url" title="instagram" target="_blank" href=""><span
                        class="u-icon u-social-icon u-social-instagram u-icon-3"><svg class="u-svg-link"
                          preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style="">
                          <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-f76c"></use>
                        </svg><svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-f76c">
                          <circle fill="currentColor" cx="56.1" cy="56.1" r="55"></circle>
                          <path fill="#FFFFFF"
      ...
      c5.5,0,9.9,4.5,9.9,9.9V73.3z"></path>
                    ...
                    <a class="u-social-url" title="linkedin" target="_blank" href=""><span
                        class="u-icon u-social-icon u-social-linkedin u-icon-4"><svg class="u-svg-link"
                          preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style="">
                          <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-43ac"></use>
                        </svg><svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-43ac">
                          <circle fill="currentColor" cx="56.1" cy="56.1" r="55"></circle>
